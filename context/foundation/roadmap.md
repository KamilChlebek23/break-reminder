...
| B | Custom reminders | `S-05` → `S-06` → `S-07` / `S-08` (parallel after S-06) | Joins Stream A at `S-01` (the same QDialog hosts both tabs). Sequenced after Stream A's first slice but otherwise independent of S-02..S-04. |
